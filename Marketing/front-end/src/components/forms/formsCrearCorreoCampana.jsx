...
const FormsCrearCorreoCampana = (props) => {
    ...
    const {siguienteIsClicked, setSiguienteIsClicked, submitSiguiente, setSubmitSiguiente} = props
    ...
    return(
        <form className={`${styles.formCrearCorreoCampana} ${siguienteIsClicked ? styles.btnSiguienteIsClicked : ""}`} 
        onSubmit={handleSubmitCorreo}>
            ...
            <div className={styles.containerAsuntoCorreo}>
                ...
                <input type="text" required minLength={1} placeholder="Asunto aquí..." 
                    name="affair"
            ...
            <button className={`${styles.btnCrearCorreo1} ${!formIsCompleted ? styles.botonDisabled : ""}`}
